with dados as (
    ...
    select
        ...
        (lancamento.vr_saldo_total * 100) / coalesce(pedido.vr_parcelamento, 0) as juros_porcent
...
trata_juros as (
    ...
    select
        ...
        (dados.juros_porcent ^ dados.prazo::integer) as juros_porcent,
...
select
    trata_juros.fornecedor,
    trata_juros.data_base,
    trata_juros.valor_contrato as valor_contrato,
    trata_juros.juros as juros,
    trata_juros.iof as iof,
    trata_juros.prazo as prazo,
    sum(trata_juros.juros_porcent) as juros_porcent,
    sum(trata_juros.saldo) as saldo
